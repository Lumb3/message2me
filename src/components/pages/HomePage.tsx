...
will have brought you to that point?"`}
        ...
        <div className="space-y-4">
          ...
          <div className="mt-8 p-4 bg-gray-900/20 border border-gray-700 rounded">
            <div className="text-gray-300 text-sm">
              <span className="text-cyan-400">💡 Navigation tip:</span> You can also use the command line above to navigate.
              Try typing commands like <span className="text-green-400 font-mono">cd vision</span> or <span className="text-green-400 font-mono">ls</span> to explore.
            </div>
          </div>
